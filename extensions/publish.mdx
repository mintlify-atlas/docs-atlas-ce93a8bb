---
title: "Package and Publish Your DevToys Extension to NuGet"
sidebarTitle: "Publish"
description: "Build a .devtoys package from your .NET class library, install it locally via the DevToys Extensions Manager, and publish it to NuGet.org."
---
