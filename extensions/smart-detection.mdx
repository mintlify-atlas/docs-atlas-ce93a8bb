...
description: "Implement IDataTypeDetector and use AcceptedDataTypeNameAttribute so DevToys automatically offers your tool when matching data is detected on the clipboard."
---
