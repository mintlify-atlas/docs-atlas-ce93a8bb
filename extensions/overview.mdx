...
description: "Build GUI and CLI tools for DevToys using IGuiTool and ICommandLineTool. Package them as .devtoys files and install via the Extensions Manager."
---
