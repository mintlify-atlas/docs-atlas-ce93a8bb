---
title: "DevToys Input Components: Text, Button, and Select"
sidebarTitle: "Input Components"
description: "Reference for DevToys SDK input components: text fields, multi-line editors, buttons, toggles, drop-down lists, and file selectors with examples."
---
