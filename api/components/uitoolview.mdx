...
description: "UIToolView is the root container returned by IGuiTool.View. It holds the root IUIElement, controls scrollability, and supports modal dialogs via OpenDialogAsync."
---
