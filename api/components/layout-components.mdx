---
title: "DevToys Layout Components: Stack, Grid, and SplitGrid"
sidebarTitle: "Layout Components"
description: "API reference for IUIStack, IUIGrid, IUISplitGrid, IUIWrap, and IUICard layout components in the DevToys SDK, with fluent builder methods and examples."
---
