...
description: "ISettingsProvider manages DevToys settings. Use GetSetting, SetSetting, and ResetSetting with a typed SettingDefinition to persist user preferences."
---
