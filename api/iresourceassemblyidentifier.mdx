---
title: "IResourceAssemblyIdentifier Interface — DevToys Extension SDK"
sidebarTitle: "IResourceAssemblyIdentifier"
description: "IResourceAssemblyIdentifier exposes the fonts and resource managers for a DevToys extension assembly. Every extension must export exactly one implementation."
---
...
public sealed class MyResourceManagerAssemblyIdentifier : IResourceAssemblyIdentifier
{
...
```
[Name(nameof(MyResourceManagerAssemblyIdentifier))]   ← on IResourceAssemblyIdentifier
        ↕ must match
ResourceManagerAssemblyIdentifier = nameof(MyResourceManagerAssemblyIdentifier)  ← in [ToolDisplayInformation]
        ↕ resolves
