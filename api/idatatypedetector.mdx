...
description: "IDataTypeDetector identifies clipboard data types in DevToys. Implement TryDetectDataAsync to parse raw data and return a typed DataDetectionResult."
---
