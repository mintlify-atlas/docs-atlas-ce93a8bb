...
description: "DevToys provides Button, Switch, SelectDropDownList, DropDownButton, and FileSelector controls for building interactive tool UIs with the GUI.* factory API."
---
