...
description: "DevToys tool UIs are built from IUIElement components. Use GUI.* static factory methods to compose layouts, inputs, labels, and interactive controls."
---
