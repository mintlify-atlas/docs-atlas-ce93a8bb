---
title: "Display Components: Label, InfoBar, ImageViewer, DataGrid, List, Progress"
sidebarTitle: "Display"
description: "DevToys display components include Label, InfoBar, ImageViewer, DataGrid, List, ProgressBar, ProgressRing, and Icon for presenting data and feedback in tool UIs."
---
...
<Note>
`IUIDataGridCell` holds an optional `IUIElement`. Use the `IUIDataGridCell.cs` factory `Cell(string text)` shorthand for plain text cells.
</Note>
